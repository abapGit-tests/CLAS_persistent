class ZCB_ABAPGIT_TESTING_PERSISTENC definition
  public
...
public section.
  ...
  methods CREATE_PERSISTENT
    importing
      !I_XUBNAME type XUBNAME
    returning
      value(RESULT) type ref to ZCL_ABAPGIT_TESTING_PERSISTENC
    raising
...
protected section.
  ...
  types TYP_OBJECT_REF type ref to ZCL_ABAPGIT_TESTING_PERSISTENC .
  types:
    begin of TYP_BUSINESS_KEY ,
      XUBNAME type XUBNAME ,
...
CLASS ZCB_ABAPGIT_TESTING_PERSISTENC IMPLEMENTATION.


  method CREATE_PERSISTENT.
***BUILD 093901
*      IMPORTING I_XUBNAME TYPE XUBNAME
*      RETURNING RESULT TYPE REF TO ZCL_ABAPGIT_TESTING_PERSISTENC
************************************************************************
...
*< Generated from mapping:
  BUSINESS_KEY-XUBNAME = I_XUBNAME.
*>
...
*< Generated from mapping:
  call method GET_PERSISTENT
       exporting I_XUBNAME = BUSINESS_KEY-XUBNAME
...
*<Generated from mapping:
  E_BUSINESS_KEY-XUBNAME  = I_DB_DATA-XUBNAME.
*>
...
************************************************************************
  ...
  data: THE_OBJECT type ref to ZCL_ABAPGIT_TESTING_PERSISTENC,
...
*<  Generated from mapping:
    OBJECT_DATA_ITEM-XUBNAME = THE_OBJECT->XUBNAME.
    OBJECT_DATA_ITEM-NAME = THE_OBJECT->NAME.
*>
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO ZCL_ABAPGIT_TESTING_PERSISTENC.
...
*< Generated from mapping:
  types: TYP_DB_DATA_LOCAL type ZABAPGIT_TST_CLP.
*>
...
*< Generated from mapping:
  field-symbols: <FS_DB_ZABAPGIT_TST_CLP> type ZABAPGIT_TST_CLP.
*>

*< Generated from mapping:
  select * from ZABAPGIT_TST_CLP
           into table DB_DATA_LOCAL_TAB
           for all entries in I_BUSINESS_KEY_TAB
           where ZABAPGIT_TST_CLP~XUBNAME = I_BUSINESS_KEY_TAB-XUBNAME.
*>
...
* * error handling
  if ( SY-SUBRC <> 0 ).
    ...
    raise exception type CX_OS_DB_SELECT
         exporting TABLE  = 'ZABAPGIT_TST_CLP'
                   TEXTID = CX_OS_DB_SELECT=>BY_BKEYTAB.
  endif. "( Error )

  loop at DB_DATA_LOCAL_TAB assigning <FS_DB_DATA_LOCAL>.

    assign <FS_DB_DATA_LOCAL> to <FS_DB_ZABAPGIT_TST_CLP>.

*< Generated from mapping:
    DB_DATA-XUBNAME = <FS_DB_ZABAPGIT_TST_CLP>-XUBNAME.
    DB_DATA-NAME = <FS_DB_ZABAPGIT_TST_CLP>-NAME.
*>
...
*<  Generated from mapping:
    <FS_OBJECT_DATA>-XUBNAME = BUSINESS_KEY-XUBNAME.
*>
...
* * ZABAPGIT_TST_CLP: internal tables for mass operation
  data DB_ITB_ZABAPGIT_TST_CLP type STANDARD TABLE OF ZABAPGIT_TST_CLP.
  data DB_UTB_ZABAPGIT_TST_CLP type STANDARD TABLE OF ZABAPGIT_TST_CLP.
  data DB_DTB_ZABAPGIT_TST_CLP type STANDARD TABLE OF ZABAPGIT_TST_CLP.

* * ZABAPGIT_TST_CLP: headlines for tables
  data DB_ILN_ZABAPGIT_TST_CLP type ZABAPGIT_TST_CLP.
  data DB_ULN_ZABAPGIT_TST_CLP type ZABAPGIT_TST_CLP.
  data DB_DLN_ZABAPGIT_TST_CLP type ZABAPGIT_TST_CLP.
...
*< Generated from mapping:
   ...
   DB_ILN_ZABAPGIT_TST_CLP-NAME = <FS_INSERT>-NAME.


   DB_ILN_ZABAPGIT_TST_CLP-XUBNAME = <FS_INSERT>-XUBNAME.
   append DB_ILN_ZABAPGIT_TST_CLP to DB_ITB_ZABAPGIT_TST_CLP.
*>
...
*< Generated from mapping:
   ...
   DB_ULN_ZABAPGIT_TST_CLP-NAME = <FS_UPDATE>-NAME.


   DB_ULN_ZABAPGIT_TST_CLP-XUBNAME = <FS_UPDATE>-XUBNAME.
   append DB_ULN_ZABAPGIT_TST_CLP TO DB_UTB_ZABAPGIT_TST_CLP.
*>
...
* * Collect Deletes
  loop at I_DELETES assigning <FS_DELETE>.
    ...
    DB_DLN_ZABAPGIT_TST_CLP-XUBNAME = <FS_DELETE>-BUSINESS_KEY-XUBNAME.

    append DB_DLN_ZABAPGIT_TST_CLP TO DB_DTB_ZABAPGIT_TST_CLP.
...
* * DB Deletes
  delete ZABAPGIT_TST_CLP FROM TABLE DB_DTB_ZABAPGIT_TST_CLP.
  if SY-SUBRC <> 0.
    raise exception type CX_OS_DB_DELETE
      exporting
        TABLE = 'ZABAPGIT_TST_CLP'.
  endif.

* * DB Inserts
  insert ZABAPGIT_TST_CLP FROM TABLE DB_ITB_ZABAPGIT_TST_CLP
...
* * DB Updates
  update ZABAPGIT_TST_CLP FROM TABLE DB_UTB_ZABAPGIT_TST_CLP.
  if SY-SUBRC <> 0.
...
*< Generated from mapping:
  COMP_STRING = I_BUSINESS_KEY-XUBNAME.
...
*<  Generated from mapping:
  THE_OBJECT->XUBNAME = I_OBJECT_DATA-XUBNAME.
  THE_OBJECT->NAME = I_OBJECT_DATA-NAME.
*>
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to ZCL_ABAPGIT_TESTING_PERSISTENC.

* * 1. Create object and set BKey attributes
  create object NEW_OBJECT.

* < Generated from mapping:
  NEW_OBJECT->XUBNAME = I_BUSINESS_KEY-XUBNAME.
* >
